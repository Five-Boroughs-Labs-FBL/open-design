// ACP Design web clipper popup. Thin UI over the service worker message API.
//
// Zero-config: no pairing. The popup just probes whether ACP Design is running
...
function render(connected) {
  ...
  // "ACP Design not running" message instead of being hidden, so it never feels broken.
}
