// ACP Design web clipper on-page UI.
//
...
//      led by the ACP Design brand mark. HIDDEN by default — turned on from
...
(function () {
  ...
  // no message listener: the popup then reported "ACP Design hasn't attached to
  ...
  async function commitCapture(el) {
    ...
    try {
      ...
      console.warn('[ACP Design] element capture failed', err);
      stopBusy();
      toast(t('extensionErrorReload'));
      return;
    } finally {
