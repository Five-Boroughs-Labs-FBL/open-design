// ACP Design Web Clipper i18n runtime.
//
...
(function () {
  ...
  const en = {
    extensionName: 'ACP Design Web Clipper',
    extensionDescription: 'Clip pages, design systems, screenshots, images, and Figma import JSON into your ACP Design Library.',
    webClipper: 'Web Clipper',
    openDesign: 'ACP Design',
    ...
    hintHtml: '<strong>ACP Design</strong> is not running. Start the app, then reopen this popup - the clipper connects automatically.',
    advanced: 'Advanced',
    ...
    refreshPageTitle: 'Reload this page so ACP Design can attach',
    ...
    openDesignNotRunning: 'ACP Design is not running - start the app first.',
    savedConnected: 'Saved - connected.',
    savedNotDetected: 'Saved, but ACP Design was not detected at that URL.',
    ...
    odNotAttached: 'ACP Design has not attached to this page yet.',
    ...
    toolbarDragLabel: 'Drag the ACP Design bar',
    toolbarHomeTip: 'ACP Design - open-design.ai',
    toolbarHomeLabel: 'ACP Design home',
    ...
    toolbarHide: 'Hide ACP Design bar',
    openDesignStartApp: 'ACP Design is not running - start the app',
    ...
    saveImageToLibrary: 'Save image to ACP Design Library',
    saveImageToOpenDesign: 'Save image to ACP Design',
  ...
  const overrides = {
    id: {
      extensionDescription: 'Klip halaman, sistem desain, tangkapan layar, gambar, dan JSON impor Figma ke Library ACP Design.',
    ...
    de: {
      extensionDescription: 'Sammle Seiten, Designsysteme, Screenshots, Bilder und Figma-Import-JSON in deiner ACP Design Library.',
    ...
    'zh-CN': {
      extensionName: 'ACP Design 网页剪藏',
      extensionDescription: '将网页、设计系统、截图、图片和 Figma 导入 JSON 剪藏到 ACP Design 素材库。',
      ...
      hintHtml: '<strong>ACP Design</strong> 未运行。启动应用后重新打开此弹窗，插件会自动连接。',
      ...
      daemonUrl: 'Daemon 地址', save: '保存', refreshPage: '刷新页面', refreshPageTitle: '刷新此页面以便 ACP Design 挂载',
      toggleOnPageBar: '切换页面浮条', toggleImageHover: '切换图片悬浮捕获按钮',
      openDesignNotRunning: 'ACP Design 未运行，请先启动应用。', savedConnected: '已保存，已连接。',
      savedNotDetected: '已保存，但该地址未检测到 ACP Design。', capturingPage: '正在捕获页面...',
      ...
      odNotAttached: 'ACP Design 尚未挂载到此页面。', elementPickerUnavailable: '此页面不可使用元素选择器，请尝试普通网站。',
      ...
      toolbarDrag: '拖动移动', toolbarDragLabel: '拖动 ACP Design 浮条', toolbarCapturePage: '捕获页面 -> 素材库',
      ...
      toolbarHide: '隐藏 ACP Design 浮条', openDesignStartApp: 'ACP Design 未运行，请启动应用',
      ...
      saveImageToLibrary: '保存图片到 ACP Design 素材库', saveImageToOpenDesign: '保存图片到 ACP Design',
    ...
    'zh-TW': {
      extensionName: 'ACP Design 網頁剪藏',
      extensionDescription: '將網頁、設計系統、截圖、圖片和 Figma 匯入 JSON 剪藏到 ACP Design 素材庫。',
    ...
    'pt-BR': {
      extensionDescription: 'Capture páginas, kits de marca, screenshots, imagens e JSON de importação do Figma na sua Library ACP Design.',
    ...
    'es-ES': {
      extensionDescription: 'Guarda páginas, kits de marca, capturas, imágenes y JSON de importación de Figma en tu Library de ACP Design.',
    ...
    ru: {
      extensionDescription: 'Сохраняйте страницы, дизайн-системы, скриншоты, изображения и Figma import JSON в библиотеку ACP Design.',
    ...
    fa: {
      extensionDescription: 'صفحه‌ها، سیستم‌های طراحی، اسکرین‌شات‌ها، تصاویر و JSON واردسازی Figma را در کتابخانه ACP Design ذخیره کنید.',
    ...
    ar: {
      extensionDescription: 'احفظ الصفحات وأنظمة التصميم ولقطات الشاشة والصور وملف Figma JSON في مكتبة ACP Design.',
    ...
    ja: {
      extensionDescription: 'ページ、デザインシステム、スクリーンショット、画像、Figma インポート JSON を ACP Design Library に保存します。',
    ...
    ko: {
      extensionDescription: '페이지, 디자인 시스템, 스크린샷, 이미지, Figma 가져오기 JSON을 ACP Design Library에 저장합니다.',
    ...
    pl: {
      extensionDescription: 'Zapisuj strony, systemy projektowe, zrzuty ekranu, obrazy i JSON importu Figma w bibliotece ACP Design.',
    ...
    hu: {
      extensionDescription: 'Oldalak, designrendszerek, képernyőképek, képek és Figma import JSON mentése az ACP Design Librarybe.',
    ...
    fr: {
      extensionDescription: 'Capturez pages, systèmes de design, captures, images et JSON import Figma dans votre Library ACP Design.',
    ...
    uk: {
      extensionDescription: 'Зберігайте сторінки, дизайн-системи, скриншоти, зображення та Figma import JSON у бібліотеку ACP Design.',
    ...
    tr: {
      extensionDescription: 'Sayfaları, tasarım sistemlerini, ekran görüntülerini, görselleri ve Figma içe aktarma JSONunu ACP Design Libraryye kaydedin.',
    ...
    th: {
      extensionDescription: 'บันทึกหน้าเว็บ ระบบดีไซน์ ภาพหน้าจอ รูปภาพ และ Figma import JSON ไปยัง ACP Design Library',
    ...
    it: {
      extensionDescription: 'Salva pagine, design system, screenshot, immagini e JSON di importazione Figma nella Library ACP Design.',
    ...
    vi: {
      extensionDescription: 'Lưu trang, hệ thống thiết kế, ảnh chụp màn hình, hình ảnh và JSON nhập Figma vào ACP Design Library.',
    ...
    nl: {
      extensionDescription: 'Sla pagina’s, designsystemen, screenshots, afbeeldingen en Figma-import-JSON op in je ACP Design Library.',
