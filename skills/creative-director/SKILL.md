...
## ACP Design orchestration mode

When this skill is invoked inside ACP Design, treat it as the design-flow
...
3. Search across every available ACP Design resource, not only this skill:
