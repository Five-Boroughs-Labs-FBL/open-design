...
> **Quick start for contributors:** This guide helps you add a new language translation to ACP Design in ~2 hours instead of ~8 hours. Follow the checklist, avoid common mistakes, and ship your PR with confidence.
...
- ✅ Alt text: `alt="ACP Design banner"`
...
- ❌ Brand names: "ACP Design", "Claude Code"
...
ACP Design currently supports **19 languages** across different surfaces:
...
- ✅ Alt text in images: `alt="ACP Design banner"` → `alt="Banner di ACP Design"`
...
- ❌ Brand names: "ACP Design", "Claude Code", "Anthropic", "Vercel"
...
- Use the English term with a brief explanation in parentheses on first use if no standard translation exists:
  ```
  ACP Design è un'alternativa open-source (codice aperto) a Claude Design.
  ```
...
```markdown
<!-- English -->
<a href="https://discord.gg/jE4MzArHX"><img alt="Discord" src="https://img.shields.io/badge/discord-join-5865F2?style=flat-square&logo=discord&logoColor=white" /></a>

<!-- Italian -->
<a href="https://discord.gg/jE4MzArHX"><img alt="Discord" src="https://img.shields.io/badge/discord-unisciti-5865F2?style=flat-square&logo=discord&logoColor=white" /></a>
```
...
- ACP Design, Claude Code, Claude Design
...
- `Skill` stays `Skill` when it names the ACP Design/Claude skill format.
  Translate only generic prose such as "ability" or "capability" as
  `capacité`.
- `fork` stays `fork` when it names the ACP Design conversation-fork feature
...
- `SOTA Harness` and `Harness` stay in English when they name the ACP Design
...
**Example:**
```markdown
ACP Design هو البديل مفتوح المصدر لـ Claude Design
```
...
```markdown
## Summary
Adds [Language] translation for ACP Design documentation.
...
- **Want to chat?** Join our [Discord](https://discord.gg/jE4MzArHX)
...
Every translation makes ACP Design accessible to more developers worldwide.
...
**Ready to contribute?** Pick a language, follow the [Quick Start](#-quick-start-adding-your-language-in-5-steps), and submit your PR. We can't wait to see ACP Design in your language! 🚀
