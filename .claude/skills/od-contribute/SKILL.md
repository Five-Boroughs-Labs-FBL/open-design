...
# od-contribute — first-contribution flow for ACP Design
...
- The user wants to *generate* a Skill / Design System from scratch → that's ACP Design itself. Run OD first, get an artifact, then come back here to ship it.
