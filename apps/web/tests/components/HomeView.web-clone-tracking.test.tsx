...
describe('web-clone example-card tracking', () => {
  ...
  // narrowed to the first-party ACP Design site to avoid shipping third-party
  ...
  it('resolves exactly the contracted ACP Design Website-clone site card', async () => {
    writeHomeGuideStage('done');
    stubPlugins();
    renderHome();
  ...
  it('renders the contracted ACP Design site card with a local eager logo', async () => {
    writeHomeGuideStage('done');
    stubPlugins();
    renderHome();
  ...
  it('falls back when the local ACP Design site card logo cannot load', async () => {
    writeHomeGuideStage('done');
    stubPlugins();
    renderHome();
