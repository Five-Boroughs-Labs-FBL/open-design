  ...
  <div className={CAGE_SUPPORT}>
    <SupportDialog
      ...
      channels={[
        ...
        { id: 'discord', name: 'Discord', href: 'https://discord.gg/jE4MzArHX', icon: <DiscordIcon /> },
      ]}
    />
  </div>
);
...
const EDGE: Cell[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      '**已合并**(OPEND-2772):产品原来在报错卡下面另起一张 `AmrGuidance`,两张卡同时出现;那张卡已删掉,〔切换到 ACP Design Cloud 并重试〕收进报错卡的主按钮位。文案仍是产品自己那句 `chat.amrCard.switchCta`,没有换成稿子的「切换到 Cloud」'
    ],
  },
  {
