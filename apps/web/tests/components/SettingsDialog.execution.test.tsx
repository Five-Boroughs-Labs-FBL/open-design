...
describe('SettingsDialog execution settings Local CLI interactions', () => {
  ...
  it('pins ACP Design to the top of the installed CLI list', () => {
...
describe('SettingsDialog MCP server interactions', () => {
  ...
  it('renders the default Claude Code install snippet after fetching daemon install info', async () => {
    ...
    expect(screen.getByRole('heading', { name: /Connect ACP Design to your coding agent/i })).toBeTruthy();
    ...
    expect(screen.getByText(/Keep ACP Design running\. Restart your coding agent after setup\./i)).toBeTruthy();
