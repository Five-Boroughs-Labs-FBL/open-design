...
export const fa: Dict = {
  ...
  'chat.amrCard.switchCta': 'سوئیچ به ACP Design Cloud',
  "chat.amrCard.switchedResend": "به ACP Design Cloud تغییر داده شد. لطفاً وظیفه را دوباره ارسال کنید.",
  ...
  "chat.runError.cliSessionRefusedMessage": "ACP Design هنوز از این نسخهٔ عامل پشتیبانی نمی‌کند. به نسخه‌ای پشتیبانی‌شده تغییر دهید و دوباره امتحان کنید.",
  ...
  'home.amrGateUnavailable': 'تأیید موجودی ACP Design Cloud ممکن نشد. دوباره ارسال کنید.',
