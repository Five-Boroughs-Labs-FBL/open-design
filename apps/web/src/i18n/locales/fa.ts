...
export const fa: Dict = {
  ...
  'chat.amrCard.switchBody': 'به سرویس رسمی مدل ACP Design Cloud سوئیچ کنید — بدون نیاز به تنظیم کلید API. پس از ورود، اعطای دسترسی و شارژ، این اجرا به‌طور خودکار دوباره انجام می‌شود.',
  ...
  'chat.amrError.authMessage': 'حساب ACP Design Cloud شما هنوز مجاز نشده است. آن را مجاز کنید تا این اجرا به‌طور خودکار دوباره انجام شود.',
  'chat.amrError.balanceMessage': 'موجودی ACP Design Cloud شما تمام شده است. برای ادامه این اجرا شارژ کنید.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'آنچه ACP Design Cloud به شما می‌دهد',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'شما از ایجنت ACP Design Cloud استفاده می‌کنید — وارد شوید تا این وظیفه بلافاصله شروع شود.',
  ...
  'chat.runError.title.signInRequired.amr': 'به ACP Design وارد نشده‌اید',
  ...
  'chat.runError.title.runtimeConfig': "خطای اجرای ACP Design",
  ...
  'chat.runError.cpuUnsupportedMessage': "محیط اجرای این عامل به مجموعه دستورالعمل پردازنده (AVX2) نیاز دارد که این دستگاه فاقد آن است، بنابراین نمی‌تواند اجرا شود. ACP Design را به آخرین نسخه که محیط اجرای سازگار دارد به‌روزرسانی کنید.",
  ...
  'chat.runError.cliSessionRefusedMessage':
    "{agent} از شروع جلسه خودداری کرد. معمولاً نسخهٔ نصب‌شده با ACP Design سازگار نیست؛ به نسخهٔ دیگری تغییر دهید و دوباره تلاش کنید.",
  ...
  'chat.runError.agentReplyIncompleteMessage': "پاسخ عامل بدون نشانه‌ای که ACP Design برای ثبت این مرحله لازم دارد برگشت؛ به همین دلیل کار نتوانست ادامه یابد. هیچ‌چیز از آنچه فرستادید از دست نرفته است؛ این مورد گاه‌به‌گاه پیش می‌آید و معمولاً تلاش دوباره کارساز است.",
  ...
  'settings.welcomeTitle': 'به ACP Design خوش آمدید',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'شروع با یک شرح',
  'settings.onboardingCreateBody': 'سایت، اپلیکیشن، ارائه، تصویر یا ویدیویی را که می‌خواهید توصیف کنید. ACP Design یک پروژه می‌سازد و کار را قابل ویرایش نگه می‌دارد.',
  ...
  'settings.onboardingMemoryCalloutBody': 'این پاسخ‌ها نمایهٔ حافظهٔ شما را شکل می‌دهند. ACP Design در هر کار از آن استفاده می‌کند و همزمان با کار شما به یادگیری ادامه می‌دهد.',
  ...
  'settings.onboardingExecutionBody': 'از سرویس میزبانی‌شده ACP Design استفاده کنید، یک عامل محلی را متصل کنید یا کلید مدل خود را بیاورید.',
  ...
  'settings.onboardingAmrCloudAuthorizeAction': 'مجوزدهی ACP Design Cloud',
  ...
  'settings.onboardingGateTooltipAmr': 'مراحل بعدی با هوش مصنوعی اجرا می‌شوند — برای ادامه وارد ACP Design Cloud شوید.',
  ...
  'settings.agentInstall.stepAuth': 'قبل از بازگشت به ACP Design، در CLI ارائه‌دهنده احراز هویت کنید (ورود یا افزودن اطلاعات API).',
  ...
  'settings.amrAccountStatus': 'وضعیت حساب ACP Design Cloud',
  ...
  'settings.amrLoginErrorCompact': 'ورود به ACP Design Cloud ناموفق بود.',
  ...
  'settings.mcpServerHint': 'ACP Design را به‌عنوان سرور MCP برای عامل برنامه‌نویسی خود در دسترس قرار دهید.',
  ...
  'settings.privacyHint': 'چه داده‌هایی با تیم ACP Design به اشتراک گذاشته می‌شود',
  'settings.privacyConsentKicker': 'به ما در بهبود ACP Design کمک کنید',
  'settings.privacyConsentLead': 'اشتراک‌گذاری داده‌های استفاده به ما کمک می‌کند عملکرد ACP Design را در جریان‌های کاری واقعی بهتر بفهمیم تا بخش‌هایی را که بیشترین اثر را بر تجربه شما دارند بهبود دهیم.',
  ...
  'settings.updateQuitFailed': 'نصب‌کننده باز شد، اما ACP Design نتوانست خودکار خارج شود.',
  ...
  'settings.mcpHint': 'به Agentهای کدنویسی (Cursor، Claude Code، VS Code…) اجازه دهید پروژه‌های ACP Design شما را مستقیماً بخوانند.',
  'settings.mcpDaemonError': 'امکان دسترسی به daemon محلی برای تعیین مسیرهای نصب وجود نداشت ({error}). مطمئن شوید که ACP Design در حال اجراست، سپس این پنل را دوباره باز کنید.',
  ...
  'settings.mcpCapabilityDefault': 'به‌صورت پیش‌فرض از پروژه و فایلی که در ACP Design باز کرده‌اید استفاده می‌کند، بنابراین می‌توانید بگویید «این را در اپ من بساز» بدون اینکه دوباره مشخص کنید کدام طراحی.',
  'settings.mcpRunningNote': 'برای موفقیت فراخوانی‌های ابزار MCP، ACP Design باید در حال اجرا باشد. اگر Agent کدنویسی خود را پیش از باز کردن ACP Design راه‌اندازی کرده‌اید، Agent را راه‌اندازی مجدد کنید تا بتواند به daemon زنده دسترسی پیدا کند.',
  ...
  'entry.followLinkedinLabel': 'دنبال کردن ACP Design در LinkedIn',
  'entry.followXiaohongshuLabel': 'دنبال کردن ACP Design در Xiaohongshu',
  ...
  "entry.cloudCalloutBody": "برای استفاده از ACP Design Cloud و همکاری در فضای ابری وارد شوید",
  "entry.cloudCalloutDismissAria": "بستن یادداشت ACP Design Cloud",
  ...
  'homeHero.chip.createPluginHint': 'یک افزونه قابل استفاده مجدد ACP Design بسازید و آن را به افزونه‌های من اضافه کنید.',
  ...
  'handoff.amrWebsite': 'باز کردن وب‌سایت ACP Design Cloud',
  ...
  'handoff.promptIntro': 'ادامه از این پوشه محلی پروژه ACP Design:',
  ...
  'pluginsHome.subtitle': 'گردش‌کارهای آماده ACP Design که همراه این runtime ارائه شده‌اند. یکی را برای بارگذاری یک پرامپت شروع انتخاب کنید، یا برای موارد بیشتر در رجیستری بگردید.',
  ...
  'pluginsHome.emptyCatalog': 'کاتالوگ خالی است. پلاگین‌های همراه با ACP Design ارائه می‌شوند و باید به‌صورت خودکار اینجا نمایش داده شوند — اگر این مشکل ادامه داشت، daemon را مجدداً راه‌اندازی کنید.',
  ...
  'pluginCard.contributeAria': 'مشارکت {title} در ACP Design',
  'pluginCard.contributeTitle': 'مشارکت افزونه در ACP Design با یک PR',
  'integrations.kicker': 'یکپارچه‌سازی',
  'integrations.lede': 'سیستم‌های خارجی را متصل کنید، ابزارهای MCP را به حلقه Agent خود بیاورید و از ACP Design در سایر IDEها، اسکریپت‌ها و خودکارسازی‌ها استفاده کنید.',
  ...
  'mcpClient.daemonError': 'دسترسی به daemon محلی ممکن نشد. مطمئن شوید ACP Design در حال اجراست، سپس این پنل را دوباره باز کنید.',
  'mcpClient.saveFailed': 'ذخیره ناموفق بود. بررسی کنید که daemon در حال اجرا باشد و دوباره تلاش کنید.',
  'useEverywhere.modalAria': 'استفاده از ACP Design در همه‌جا',
  'useEverywhere.modalTitle': 'استفاده از ACP Design در همه‌جا',
  'useEverywhere.modalSubtitle': 'ACP Design را در هر IDE، Agent یا اسکریپتی بگنجانید — CLI، HTTP، MCP و Skills. از «Copy guide for an agent» استفاده کنید و آن را در Claude Code، Codex، Cursor، openclaw یا hermes جای‌گذاری کنید تا همه‌چیز راه‌اندازی شود.',
  ...
  'useEverywhere.section.overview.heading': 'ACP Design هر جا که Agent شما کار کند، کار می‌کند',
  'useEverywhere.section.overview.intro': 'ACP Design چیزی فراتر از یک پنجره است — یک daemon محلیِ دارای دسترسی ویژه (`od`) به‌علاوه یک رجیستری از Skills + Design-Systems + Atoms است. به‌محض اینکه روی دستگاه شما در حال اجرا باشد، هر code agent (Claude Code، Codex، Cursor، OpenCode/openclaw، Hermes، یا اسکریپت خودتان) می‌تواند تولیدها را هدایت کند، پروژه‌ها را بررسی کند و از طریق چهار سطح قابل‌تعویض، آثار طراحی تولید کند.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` برای اسکریپت‌های headless، CI و اتوماسیون shell.',
  'useEverywhere.section.overview.bullet2': 'سرور MCP — ACP Design را به‌عنوان یک سرور Model Context Protocol سیم‌کشی می‌کند تا هر Agent سازگار با MCP بتواند skillها را فهرست کند، سناریوها را اجرا کند و آثار را بخواند.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — بسته‌های آمادهٔ `SKILL.md` (سازگار با Claude) که هر Agent موجود در PATH شما می‌تواند بدون نیاز به ACP Design اصلاً فراخوانی‌شان کند.',
  ...
  'useEverywhere.section.cli.heading': 'کنترل ACP Design از هر shell',
  ...
  'useEverywhere.section.mcp.heading': 'در معرض قرار دادن ACP Design به‌عنوان یک سرور MCP برای هر Agent کدنویسی',
  'useEverywhere.section.mcp.intro': 'ACP Design با یک سرور Model Context Protocol (`od mcp`) ارائه می‌شود که به هر کلاینت سازگار با MCP — Cursor، Claude Code، Antigravity، VS Code Copilot Chat، openclaw، hermes — اجازه می‌دهد ابزارهای ACP Design را کشف کند (فهرست‌کردن skillها، رندر پیش‌نمایش‌ها، تولید رسانه، اجرای پلاگین‌ها) بدون نیاز به اجرای دستی در shell. این daemon برای هر کلاینت اصلی یک قطعهٔ نصب آمادهٔ جای‌گذاری را از طریق `GET /api/mcp/install-info` منتشر می‌کند.',
  ...
  'useEverywhere.section.mcp.footer': 'در اپلیکیشن ACP Design، به Settings ← Integrations بروید تا یک دستور نصب مخصوص کلاینت (Cursor، Claude Code، Antigravity، VS Code) را کپی کنید، به‌جای ویرایش دستی JSON.',
  ...
  'useEverywhere.section.skills.heading': 'Skillهای آمادهٔ استفاده برای هر Agent — حتی بدون اجرای ACP Design',
  'useEverywhere.section.skills.intro': 'یک Skill دایرکتوری‌ای است با یک `SKILL.md` سازگار با Claude (فرانت‌متر YAML + بدنه). ACP Design این فرمت را با namespace به نام `od:` گسترش می‌دهد (`mode`، `preview`، `design_system`، `inputs`، …) تا همان اثر هم درون ACP Design و هم توسط یک Agent معمولی مانند Claude Code، Codex، openclaw یا hermes قابل‌استفاده باشد. کشف از یک زنجیرهٔ اولویت پیروی می‌کند تا پروژه‌ها بتوانند skillهای خود را بازنویسی کنند.',
  ...
  'useEverywhere.section.skills.snippet1': 'حداقل SKILL.md (front matter سازگار با Claude + افزوده‌های ACP Design)',
  ...
  'entry.githubStarAria': 'به ACP Design در GitHub ستاره بدهید',
  ...
  'newproj.locationDefault': 'پروژه‌های ACP Design',
  ...
  'avatar.amrConsole': 'حساب ACP Design Cloud',
  ...
  'socialShare.openDesignSection': 'اشتراک‌گذاری ACP Design',
  'socialShare.openDesignTitle': 'ACP Design در GitHub',
  'socialShare.openDesignText': 'ACP Design یک فضای کاری با کد منبع در دسترس برای ساخت، ویرایش، استقرار و تحویل آرتیفکت‌های طراحی است.',
  ...
  'socialShare.projectText': 'ساخته‌شده با ACP Design: {title}. آرتیفکت مستقرشده را ببینید و به مخزن ستاره بدهید: {repo}',
  'socialShare.projectCopyText': 'ساخته‌شده با ACP Design: {title}\n{url}\nمخزن ACP Design: {repo}',
  ...
  'brandEnrichment.body': "ACP Design یک استخراج عمیق تر را در پس زمینه اجرا می کند، skills مناسب design system را خودکار اعمال می کند و همین سیستم را درجا به روز می کند. این کار ممکن است 10 تا 20 دقیقه طول بکشد؛ می توانید به کارتان ادامه دهید.",
  ...
  'chat.activeFilePlaceholder': 'از ACP Design بخواهید {file} را تغییر دهد...',
  ...
  'chat.mode.design.solves': 'وقتی می خواهید ACP Design فایل بسازد، workspace را به روز کند یا brief را به خروجی های چندرسانه ای قابل تحویل تبدیل کند استفاده کنید.',
  ...
  'preview.shareTextDefault': 'قالب ACP Design: {title}',
  ...
  'preview.errorBody': 'دریافت HTML نمونه با خطا مواجه شد. مطمئن شوید ACP Design در حال اجراست و دوباره تلاش کنید.',
  ...
  'designFiles.canvasView': 'بوم',
  'designFiles.allScreens': 'همه صفحه‌ها',
  'designFiles.fitCanvas': 'برازش',
  'designFiles.openSurface': 'باز کردن {title}',
  'designFiles.statusWaived': 'صرف‌نظر شده',
  'designFiles.statusMissingFile': 'فایل موجود نیست',
  'designFiles.statusGenerating': 'در حال ایجاد',
  'designFiles.statusReady': 'آماده',
  'designFiles.manifestUnavailable': 'نمای کلی صفحه‌ها در دسترس نیست. فایل‌های صفحهٔ ایجادشده همچنان در دسترس‌اند.',
  ...
  'designFiles.usefulInfoTip7': 'از ACP Design راضی هستید؟ در GitHub به ما ستاره بدهید.',
  ...
  'designFiles.usefulInfoTip18': 'برای آموزش‌ها و دموها، ACP Design را در YouTube دنبال کنید.',
  'designFiles.usefulInfoTip19': 'برای اخبار محصول، ACP Design را در LinkedIn دنبال کنید.',
  'designFiles.usefulInfoTip20': 'برای نکته‌ها و الهام، ACP Design را در Xiaohongshu دنبال کنید.',
  ...
  'fileViewer.shareMenuPublishViaOd': 'اشتراک‌گذاری سریع · ACP Design',
  ...
  'fileViewer.publishFileRequiresWorkspace': 'ایجاد پیوند اشتراک‌گذاری نیازمند ورود به فضای کاری است. به ACP Design Cloud وارد شوید یا این فایل را از طریق استقرار به اشتراک بگذارید.',
  ...
  'assistant.shareToOpenDesign': 'اشتراک‌گذاری در ACP Design',
  ...
  'pet.tabBuiltInHint': 'همراهان منتخب همراه ACP Design — یکی را انتخاب و فرزندخوانده کن.',
  ...
  'pet.codexBundledTitle': 'همراه ACP Design ارائه می‌شود — نیازی به دانلود نیست.',
  ...
  'settings.projectLocationsDescription': 'پایه‌های کاری اضافه کنید که می‌توانند چند پوشهٔ پروژهٔ ACP Design را در خود داشته باشند. پروژه‌های جدید به‌صورت یک پوشه داخل پایهٔ انتخاب‌شده ذخیره می‌شوند.',
  ...
  'settings.customInstructionsHint': 'دستورالعمل‌های ثابتی که ACP Design باید در هر گفت‌وگو دنبال کند. حقایق، ترجیحات و زمینهٔ پروژه را به‌عنوان حافظه ذخیره کنید.',
  ...
  'settings.memoryStarterProjectDesc': 'ACP Design v0.5 — ویرایشگر طراحی مبتنی بر گفتگو',
  ...
  'updater.activeRunsTitle': 'ACP Design هنوز در حال کار است',
  'updater.activeRunsBody': '{count} کار فعال هنوز در حال اجراست. راه‌اندازی مجدد اکنون آن‌ها را متوقف می‌کند.',
  'updater.activeRunsUnknownBody': 'ACP Design نتوانست بررسی کند که آیا کاری در حال اجراست. راه‌اندازی مجدد ممکن است کار فعال را متوقف کند.',
  'updater.availableBody': 'ACP Design {version} موجود است. پیش از باز شدن نصب‌کننده دانلود می‌شود.',
  ...
  'updater.installerOpenBody': 'نصب‌کننده باز است. ACP Design در حال بسته شدن است تا بتوانید به‌روزرسانی را کامل کنید.',
  ...
  'updater.quitButton': 'بستن ACP Design',
  'updater.quitFailedBody': 'نصب‌کننده باز است، اما ACP Design بسته نشد. پیش از جایگزینی برنامه، ACP Design را ببندید.',
  'updater.quitFailedTitle': 'امکان بستن نیست',
  'updater.quitting': 'در حال بستن...',
  'updater.ready': 'به‌روزرسانی آماده است',
  'updater.readyGeneric': 'نسخه جدید آماده است. ACP Design بسته می‌شود و نصب‌کننده را باز می‌کند.',
  'updater.readyVersion': 'ACP Design {version} آماده است. ACP Design بسته می‌شود و نصب‌کننده را باز می‌کند.',
  'updater.reinstallLearnMore': 'اطلاعات بیشتر',
  'updater.reinstallReadyGeneric': 'این به‌روزرسانی به نصب مجدد کامل نیاز دارد. ACP Design بسته می‌شود و نصب‌کننده باز خواهد شد.',
  'updater.reinstallReadyVersion': 'ACP Design {version} به نصب مجدد کامل نیاز دارد. ACP Design بسته می‌شود و نصب‌کننده باز خواهد شد.',
  ...
  'whatsNew.updatedTitle': 'ACP Design {version} آمد',
  ...
  'dsManager.createBody': 'برند، محصول، کد، دارایی‌ها و مراجع طراحی خود را به ACP Design بیاموزید.',
  ...
  'settings.customInstructionsDesc': 'دستورالعمل‌های ثابتی که ACP Design در هر گفت‌وگو از آن‌ها پیروی می‌کند. این‌ها حافظه ذخیره‌شده نیستند؛ برای واقعیت‌ها، ترجیحات و بافت پروژه از حافظه استفاده کنید.',
  ...
  'onboarding.buildBody': 'ACP Design برند شما را به یک سیستم طراحی قابل‌استفاده‌ی مجدد تبدیل می‌کند و هر چیزی را که می‌سازید هماهنگ و وفادار به برند نگه می‌دارد.',
  ...
  'campaign.deepseekV4Flash.ruleSummary': 'از ۱۳ تا ۲۷ اوت، کاربران پولی می‌توانند DeepSeek V4 Pro و V4 Flash را در ACP Design رایگان استفاده کنند. سوءاستفاده گسترده ممکن است دسترسی کمپین را متوقف کند.',
  'campaign.deepseekV4Flash.windowLabel': '۱۳–۲۷ اوت',
  'campaign.deepseekV4Flash.weekFreeSuffix': 'دو هفته رایگان',
  'campaign.deepseekV4Flash.boundary': 'سهمیه نامحدود مدل و تعداد تولید رایگان پلن فقط داخل ACP Design اعمال می‌شود — نه از طریق MCP، CLI، API یا سطوح دیگر. تفسیر نهایی با ACP Design است. برخی مدل‌ها ممکن است در ساعات شلوغی نیاز به نوبت داشته باشند.',
  ...
  'experienceSurvey.tag': "منتظر بازخورد شما هستیم — با هم ACP Design را بهتر کنیم",
  'experienceSurvey.close': "بستن",
  'experienceSurvey.recommendation': "چقدر احتمال دارد ACP Design را به همکار یا دوستتان پیشنهاد دهید؟",
  ...
  'chat.designSystemStatus.description': "ACP Design در حال استفاده از منابع راه‌اندازی برای ساخت این پروژه است.",
  'labs.title': "آزمایشگاه ACP Design",
  ...
  'labs.harnessHint': "با فعال‌سازی، تولید بعدی از جدیدترین استراتژی ACP Design استفاده می‌کند و خروجی محسوساً پرداخته‌تر است (بتا)",
  'labs.harnessTooltip': "به agent harness ای که ACP Design برای کارهای طراحی ساخته سوئیچ می‌کند. چیدمان، ساختار و کامل بودن خروجی به‌طور محسوس بهتر می‌شود.",
