...
export const en: Dict = {
  ...
  'settings.onboardingAcpTitle': 'Sign in with ACP',
  'settings.onboardingAcpBody': 'Use your Agent Control Panel account to open Open Design. You will only see the projects tied to that account.',
  'settings.onboardingAcpSignIn': 'Sign in with ACP',
