...
export function renderDiscoveryAndPhilosophy(
  ...
  _options: { streamFormat?: string | undefined; claimedDesignSurfaceCount?: number | undefined } = {},
): string {
  const invariant = executionProfile === 'text_artifact'
