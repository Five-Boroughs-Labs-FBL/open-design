...
import { EXPORT_FORMATS, EXPORT_IMAGE_FORMATS, DESIGN_MANIFEST_MAX_SURFACES, mediaFailureNextStep } from '@open-design/contracts';
...
const PROJECT_STRING_FLAGS = new Set([
  ...
  'source', 'out', 'file', 'expected-revision',
  'surface-ids',
...
const PROJECT_BOOLEAN_FLAGS = new Set(['help', 'h', 'json', 'follow', 'catalog', 'thumbnail']);
