...
import type { AmcCredential } from './amc-credential.js';
...
export interface ChatRun {
  ...
  designGenerationSurfaces?: Array<{ surfaceId: string; file: string }> | null;
  /** In-process fence only. Intentionally not persisted across daemon restarts. */
