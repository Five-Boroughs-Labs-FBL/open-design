...
description: Open a pull request adding a local ACP Design plugin to the ACP Design community catalog using gh CLI.
triggers:
  - contribute plugin
  - open design pr
  - github pull request
...
Use this workflow when the active project contains a copied plugin folder and the user wants to propose it for the ACP Design community catalog.
...
Keep the pull request focused. Do not modify unrelated ACP Design files unless a manifest validation issue requires a tiny supporting change.
