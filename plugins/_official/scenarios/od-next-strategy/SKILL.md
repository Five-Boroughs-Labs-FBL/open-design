...
When ACP Design supplies a validated V2 binding, load the assets in this order:
...
are staged by ACP Design into the project directory (`.od-frames/`) for the
...
runtime facts exist unless ACP Design supplied them.
